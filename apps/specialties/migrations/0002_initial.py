...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('specialties_specialty', (
            ...
            ('cipher', self.gf('django.db.models.fields.IntegerField')(default=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=True, max_length=200)),
            ('cover', self.gf('sorl.thumbnail.fields.ImageField')(default=True, max_length=100)),
            ('text', self.gf('ckeditor.fields.RichTextField')(default=True)),
        ))
    ...
    models = {
        ...
        'specialties.specialty': {
            ...
            'cipher': ('django.db.models.fields.IntegerField', [], {'default': 'True'}),
            'cover': ('sorl.thumbnail.fields.ImageField', [], {'default': 'True', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'True', 'max_length': '200'}),
            'text': ('ckeditor.fields.RichTextField', [], {'default': 'True'})
        },
