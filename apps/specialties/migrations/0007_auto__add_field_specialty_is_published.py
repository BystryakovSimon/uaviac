...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Specialty.is_published'
        db.add_column('specialties_specialty', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Specialty.is_published'
        db.delete_column('specialties_specialty', 'is_published')
