...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.is_published'
        db.add_column('documents_license', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Budget.is_published'
        db.add_column('documents_budget', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'StudPosition.is_published'
        db.add_column('documents_studposition', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.is_published'
        db.delete_column('documents_license', 'is_published')

        # Deleting field 'Budget.is_published'
        db.delete_column('documents_budget', 'is_published')

        # Deleting field 'StudPosition.is_published'
        db.delete_column('documents_studposition', 'is_published')
